...
@Builder
@ToString
@ApiModel(value = "ReqSuscriptionDTO", description = "request for a single config view of column")
public class ReqSuscriptionDTO implements Serializable {
	...
	@NotNull
	@ApiModelProperty(value = "client birthdate", position = 4)
	private Date dateOfBirth;

	@NotNull
	@ApiModelProperty(value = "flag for consent", position = 5)
	Integer flag;
